package com.dhh.hugeimageview.huge;
    ...
    private class LoadTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... params) {
            if (mDecoder != null) {
                ...
                Bitmap bitmap = mDecoder.decodeRegion(mSampleRect, options);
                Log.d("LoadTask", "bitmap==null:" + (bitmap == null));
                return bitmap;
            }
            return null;
        }
